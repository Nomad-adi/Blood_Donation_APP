...
public class DonarRegisterationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DonarRegisterationActivity.this, LoginActivity.class);
        ...
        registerbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(bloodGroups.equals("Select your blood groups")){
                    Toast.makeText(DonarRegisterationActivity.this,"Select blood groups", Toast.LENGTH_LONG).show();
                    return;
                }
                else{
                    ...
                    mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                ...
                                Toast.makeText(DonarRegisterationActivity.this, "error"+error, Toast.LENGTH_SHORT).show();
                            }
                            else{
                                ...
                                userInfo.put("search","donor"+bloodGroups);

                                userDatabasereference.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    @Override
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(DonarRegisterationActivity.this, "Data set Successfully", Toast.LENGTH_SHORT).show();
                                        }
                                        else{
                                            Toast.makeText(DonarRegisterationActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                        }
                                        finish();
                                ...
                                if(resultUri!=null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(DonarRegisterationActivity.this, "Image Upload Failed", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabasereference.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful()){
                                                                    Toast.makeText(DonarRegisterationActivity.this, "Image Url added to Database", Toast.LENGTH_SHORT).show();
                                                                }
                                                                else{
                                                                    Toast.makeText(DonarRegisterationActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                    ...
                                    Intent mainIntent = new Intent(DonarRegisterationActivity.this,MainActivity.class);
